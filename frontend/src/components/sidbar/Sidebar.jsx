...
export default function Sidebar() {
  ...
  return (
    <div className={`sidebar d-flex flex-column text-white ${collapsed ? "collapsed" : ""}`}>
      <div className="d-flex justify-content-between align-items-center p-3">
        <NavLink to="/" className="text-white text-decoration-none d-flex align-items-center gap-2">
          {!collapsed && <h5 className="mb-0">🔥 Homefire</h5>}
        </NavLink>
        <button
