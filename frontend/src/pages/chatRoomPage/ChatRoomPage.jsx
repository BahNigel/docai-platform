...
import { FiSend, FiUpload, FiMoreVertical, FiCopy, FiTrash2 } from "react-icons/fi";
  ...
  return (
    <div className="d-flex min-vh-100 text-light" style={{ backgroundColor: "#0f172a" }}>
        ...
        <div className="flex-grow-1 d-flex flex-column align-items-center justify-content-center px-3">
            ...
            >
                ...
                {messages.length === 0 ? (
                    <div className="text-center" style={{ maxWidth: "600px", width: "100%" }}>
                        <h1 className="mb-4" style={{ fontSize: "2.5rem" }}>Ask a question</h1>
                        <p className="mb-3" style={{ color: "white" }}>
                            Curious about AI, ML, or neural networks? Ask any CS-level question here.
                        </p>
                        <div className="alert alert-info py-2" style={{ fontSize: "1rem" }}>
                            Replies you get here will only be based on the documents you uploaded.
                        </div>
                    </div>
                ) : (
                    <div style={{ padding: "0 1rem", maxWidth: "600px", width: "100%" }}>
                        {messages.map((msg) => (
                            <div
                                key={msg.id}
                                ...
                                >
                                    <div className="d-flex justify-content-between align-items-start">
                                        <div style={{ textAlign: "right" }}>
                                            <div>{msg.text}</div>
                                            <small className="text-light" style={{ fontSize: "0.8rem", opacity: 0.7 }}>
                                                {msg.timestamp}
                                            </small>
                                        </div>
                                        <div className="position-relative">
                                            <button
                                                ...
                                                onMouseLeave={(e) => e.currentTarget.style.opacity = dropdownOpen === msg.id ? 1 : 0}
                                            >
            ...
            <div className="position-relative mb-3" style={{ maxWidth: "600px", width: "100%" }}>
                <textarea
                    ref={textareaRef}
