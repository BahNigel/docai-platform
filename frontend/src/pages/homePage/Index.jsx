      ...
      >
        ...
        <div className="row">
                ...
                <div
                  ...
                  style={{ backgroundColor: "#1a2238", border: "1px solid #2e3b5c" }}
                >
                  <input
                  type="text"
                  ...
                  >
                    ...
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu dropdown-menu-end" aria-labelledby={`dropdownMenuButton${idx}`}>
                ...
                >
                  ...
                  style={{ backgroundColor: "#0f172a", color: "white", border: "1px solid #2e3b5c" }}
                  >
